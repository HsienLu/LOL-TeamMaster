import{b as c,a as p,l as v}from"./main-6231738c.js";import"./header-6a8ecdaf.js";let o=[];const u=document.querySelector(".popularTeamsCard"),x=document.querySelector(".popularPlayersCard");function y(){f(),m("#popularTeamsSwiper",3,1),k()}const f=async()=>{try{let i=[];const a=(await c.get(`${p}/teamsThumb?_sort=desc`)).data;let d="";for(const n of a){let e=[],g=[],s=[],t=[],b=n.teamMerberId.filter(l=>l>0);(await c.get(`${p}/teamsMember/${n.id}`)).data.forEach(l=>{l===null?g.push(0):g.push(l.avatar),l===null?e.push(0):e.push(l.username),l===null?s.push(0):s.push(l.userRank),l===null?t.push(0):t.push(l.likeHero)}),d+=`        
          ...
          <div class="card-body">
            <ul>
                ...
                <div class="d-flex justify-content-between">
                  <div class="parallelogramHero">
                    ...
                    background-size:cover;
                        background-image: url(./images/${t[0]===0?"img-team-player@2x.png":`champion/${t[0]}.jpg`});
                      "></div>
                  </div>
              ...
              <div class="d-flex justify-content-between">
                <div class="parallelogramHero">
                  ...
                  background-position:0px -100%;
                  background-size:cover;
                      background-image: url(./images/${t[1]===0?"img-team-player@2x.png":`champion/${t[1]}.jpg`});
                    "></div>
                </div>
                <div class="parallelogramRank">
                  <div class="parallelogramContent teamCardRankBg" style="
            ...
            <div class="d-flex justify-content-between">
              <div class="parallelogramHero">
                ...
                background-position:0px -100%;
                background-size:cover;
                    background-image: url(./images/${t[2]===0?"img-team-player@2x.png":`champion/${t[2]}.jpg`});
                  "></div>
              </div>
              <div class="parallelogramRank">
                <div class="parallelogramContent teamCardRankBg" style="
          ...
          <div class="d-flex justify-content-between">
            <div class="parallelogramHero">
              ...
              background-size:266px auto;
                  background-image: url(./images/${t[3]===0?"img-team-player@2x.png":`champion/${t[3]}.jpg`});
                "></div>
            </div>
            <div class="parallelogramRank">
              <div class="parallelogramContent teamCardRankBg" style="
          ...
          <div class="parallelogramHero">
            <div class="parallelogramContent teamCardHeroBg" style="
              ...
              background-size:266px auto;
                ...
                background-image: url(./images/${t[4]===0?"img-team-player@2x.png":`champion/${t[4]}.jpg`});
              "></div>
          </div>
          <div class="parallelogramRank">
            <div class="parallelogramContent teamCardRankBg" style="
        ...
        </div>`}u.innerHTML=d}catch(i){console.error("Error fetching data:",i)}};function k(){c.get(`${p}/users?_embed=friendLists&_sort=thumb&_order=desc`).then(i=>{o=i.data,o.length=11,C(o),m("#popularPlayersSwiper",4,2)}).catch(i=>{console.log(i)})}function C(i){let r="";i.forEach((a,d)=>{r+=`<div class="swiper-slide friendListCard border border-2 border-radius border-primary bg-dark blueShadow">
    <div class="meber-card-top">
      <div class="member-avatar position-relative">
        <div class="avatar">
          <img
            src="./images/avatar/${a.avatar}.png"
            alt=""
        ...
        >
          <div class="parallelogram-1">
            <div
              ...
              style="
                background-image: url(./images/ranking/${a.userRank}.png);
                background-size: cover;
