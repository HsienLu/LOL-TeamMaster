import{a as s,u as x,S as d}from"./main-479ee411.js";import"./header-2643204d.js";let i=location.search.toString().split("=")[1];const f={TOP:0,JG:1,MID:2,AD:3,SUP:4},u=async l=>{try{const t=await axios.get(`${s}/teams/${l}?_expand=user`),o=await axios.get(`${s}/teamsMember/${l}`);console.log(t.data),console.log(o.data),console.log(t.data.teamNotice);let c=t.data.teamNotice.map(e=>`<li class="fs-5 fs-lg-4">${e}</li>`).join(""),a=o.data.map(e=>e===null?e=0:e=e);console.log(a);let m=a.map(e=>`
    <li>
        <div
