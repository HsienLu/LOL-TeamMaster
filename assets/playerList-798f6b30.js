import{u as g,b as l,a as o,m as n,S as c}from"./main-81d082ef.js";import"./header-56cae863.js";g||(location.href="index.html");let h=[],d=[],b=0,u=$("#pagination");const v=document.querySelector("#playerThumbDesc"),C=document.querySelector("#playerThumbAsc"),f=document.querySelector(".jsPlayerWrap"),y=document.querySelector("#playerRankSelect"),w=document.querySelector(".jsPlayerSearch"),k=document.querySelector(".jsPlayerSearchBtn");function x(a){let t="";a.forEach(e=>{t+=`<div class="playerListCard col-lg-4 col-md-6 col-12 mt-18">
        <div
