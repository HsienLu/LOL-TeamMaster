...
axios
  ...
  .then((res) => {
    ...
    selectActiveMd.src = `./images/${res.data.avatar}.png`;
    ...
    setMemberHero.style = `background-image: url(./images/${res.data.likeHero}.jpg)`;
  })
  .catch((error) => {
    console.log(error);
  });
...
jsAvatarWrap.addEventListener("click", (e) => {
  ...
  selectActiveMd.src = `./images/${avatarSelect}.png`;
});
...
selectHero.addEventListener("change", (e) => {
  setMemberHero.style = `background-image: url(./images/${selectHero.value}.jpg)`;
});
