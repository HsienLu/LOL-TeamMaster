import{u as h,b as n,a as l,m as s,S as m}from"./main-2f854f6b.js";import"./header-32b19688.js";h||(location.href="index.html");let d=[],i=[],g=0,o=$("#pagination");const v=document.querySelector("#playerThumbDesc"),C=document.querySelector("#playerThumbAsc"),c=document.querySelector(".jsPlayerWrap"),y=document.querySelector("#playerRankSelect"),x=document.querySelector(".jsPlayerSearch"),w=document.querySelector(".jsPlayerSearchBtn");function k(a){let t="";a.forEach(r=>{t+=`<div class="playerListCard col-lg-4 col-md-6 col-12 mt-18">
        <div
